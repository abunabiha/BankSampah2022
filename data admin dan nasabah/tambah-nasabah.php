    ...
    if(isset($_POST['simpan'])){
      ...
      if (mysqli_fetch_array($sql) > 0) {
        echo "<script>
              ...
              content='0; url=http://localhost/db_banksampah/page/admin.php?page=data-nasabah-full'>";
...
<body>
	   ...
	   <form id="daftar_user" action="" method="post" onsubmit="return cek_data()">
         ...
         <div class="form-group">
           ...
           <input type="text" placeholder="Masukan saldo" name="saldo" />
         </div>
         <div class="form-group">
           <label class="">sampah</label>
           <input type="text" placeholder="Masukan sampah" name="sampah" />
         </div>
