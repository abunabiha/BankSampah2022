...
<body>
	...
	<table id="example" class="display" cellspacing="0" width="100%" border="0" >
        ...
        <tr align="center">
            ...
            <td>
              <?php
                        $saldonya = mysqli_query($conn, "SELECT SUM(total) AS totalsaldo FROM jemput WHERE nin='".$row['nin']."'");
            ...
            <td>
              <?php 
                    $querysampah = mysqli_query($conn, "SELECT SUM(berat) AS totalberat FROM jemput WHERE nin='".$row['nin']."'");
            ...
            <td>
                ...
                <a onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')" href="../system/function/delete-nasabah.php?id=<?php echo $row['nin']; ?>">
