	...
	<body>
		...
		<div class="sidebar">
			<ul>
				...
				<li>
					<a href="admin.php?page=data-sampah"><span class="fa fa-trash" aria-hidden="true"></span>Jenis Sampah</a>
				</li>
				
				<li>
					<a href="admin.php?page=data-jemput"><span class="fa fa-handshake-o" aria-hidden="true"></span>Transaksi Jemput</a>
				</li>
				...
				<?php 
					...
					switch ($page) {
						...
						case 'jenis-sampah':
							...
							break;
						case 'tambah-data-jemput':
							include "../system/function/tambah-jemput.php";
							break;
						case 'edit-jemput':
							include "../system/function/edit-jemput.php";
							break;
						case 'tambah-data-tarik':
							include "../system/function/tambah-tarik.php";
							break;
						case 'data-jemput':
							include "../system/function/view-jemput.php";
							break;
						case 'data-tarik':
